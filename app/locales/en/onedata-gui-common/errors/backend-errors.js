...
export default {
  ...
  translationParts: {
    ...
    caveatErrors: {
      ...
      geocountry: 'Provided token can only be used from an IP address that {{listType}} from the following country: {{countries}}.',
      georegion: 'Provided token can only be used from an IP address that {{listType}} from the following region: {{regions}}.',
      consumer: 'The consumer of provided token must authenticate as {{consumers}}.',
      whitelist: 'comes',
      blacklist: 'does NOT come',
      any: 'any',
      userIdsLabel: 'users (id): ',
      groupIdsLabel: 'groups (id): ',
      providerIdsLabel: 'providers (id): ',
    },
  },
};
