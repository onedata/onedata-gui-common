...
export default {
  ...
  illegalSupportStageTransition: 'Illegal support stage transition: this operation cannot be performed while the storage backend is in stage "{{currentStorageStage}}" and provider is in stage "{{currentProviderStage}}".',
  ...
  spaceAlreadySupportedWithImportedStorage: 'Space (ID: "{{spaceId}}") is already supported with an imported storage backend (ID: "{{storageId}}").',
  ...
  requiresPosixCompatibleStorage: 'Cannot apply for storage backend (ID: {{storageId}}) – this operation requires a POSIX-compatible storage (any of: {{posixCompatibleStorages}}).',
  autoStorageImportNotSupported: 'Cannot configure auto storage import on storage backend (ID: {{storageId}}) – this operation requires any of: {{supportedStorages}} storage backend with canonical path type and on object storages (any of: {{supportedObjectStorages}}) it requires blockSize = 0.',
  storageImportNotSupported: 'Cannot configure storage import on storage backend (ID: {{storageId}}) – this operation requires storage backend with canonical path type and on object storages (any of: {{objectStorages}}) it requires blockSize = 0.',
  statOperationNotSupported: 'Storage backend (ID: {{storageId}}) does not support the `stat` operation or equivalent used for acquiring files metadata.',
