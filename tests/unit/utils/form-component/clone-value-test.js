...
describe('Unit | Utility | form component/clone value', function () {
  it('clones nested values tree', function () {
    ...
    expect(get(valuesCopy, 'field2')).to.deep.equal(get(values, 'field2'));
    expect(get(valuesCopy, 'field2')).to.not.equal(get(values, 'field2'));
    ...
    expect(get(valuesCopy, 'field5')).to.deep.equal(get(values, 'field5'));
    expect(get(valuesCopy, 'field5')).to.not.equal(get(values, 'field5'));
  });
});
