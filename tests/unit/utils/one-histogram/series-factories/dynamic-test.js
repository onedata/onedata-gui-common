...
import dynamicFactory from 'onedata-gui-common/utils/one-histogram/series-factories/dynamic';

describe('Unit | Utility | one histogram/series factories/dynamic', function () {
