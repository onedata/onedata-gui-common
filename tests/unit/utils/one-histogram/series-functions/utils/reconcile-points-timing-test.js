...
import reconcilePointsTiming from 'onedata-gui-common/utils/one-histogram/series-functions/utils/reconcile-points-timing';

describe('Unit | Utility | one histogram/series functions/utils/reconcile points timing', function () {
