...
import staticFactory from 'onedata-gui-common/utils/one-time-series-chart/series-group-factories/static';
import sinon from 'sinon';

describe('Unit | Utility | one time series chart/series group factories/static', function () {
