...
import dynamicFactory from 'onedata-gui-common/utils/one-time-series-chart/series-group-factories/dynamic';

describe('Unit | Utility | one time series chart/series group factories/dynamic', function () {
