...
import asBytesPerSecond from 'onedata-gui-common/utils/one-time-series-chart/transform-functions/as-bytes-per-second';
import {
  createContext,
  createConstArgument,
...
describe('Unit | Utility | one time series chart/transform functions/as bytes per second', function () {
