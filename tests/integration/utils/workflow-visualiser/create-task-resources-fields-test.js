...
describe('Integration | Utility | workflow visualiser/create task resources fields', function () {
    ...
    this.set('rootGroup', FormFieldsRootGroup.create({
      ...
      fields: [
        FormFieldsGroup.create({
          // weird name to match translations path
          name: 'createTaskResourcesFields',
          fields: createTaskResourcesFields({
            pathToGroup: 'createTaskResourcesFields',
