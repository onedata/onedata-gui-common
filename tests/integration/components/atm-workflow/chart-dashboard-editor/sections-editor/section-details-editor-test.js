...
describe('Integration | Component | atm-workflow/chart-dashboard-editor/sections-editor/section-details-editor',
  function () {
    setupRenderingTest();
...
async function renderComponent() {
  await render(hbs`{{atm-workflow/chart-dashboard-editor/sections-editor/section-details-editor
    section=section
