...
import { getElementsStructure } from './chart-dashboard-editor/sections-editor-test';
...
describe('Integration | Component | atm-workflow/chart-dashboard-editor (main)', function () {
  setupRenderingTest();

  it('has class "chart-dashboard-editor"', async function () {
    const helper = new Helper(this);

    await helper.render();

    expect(find('.chart-dashboard-editor')).to.exist;
  });
  ...
  it('allows to edit charts content via "edit content" in chart element', async function () {
    ...
    expect(find('.view-title')).to.have.trimmed.text('Chart editor: 1');
  });
