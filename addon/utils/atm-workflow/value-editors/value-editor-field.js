...
export const ValueEditorField = FormField.extend({
  ...
  setupEditorStateManager() {
    ...
    if (this.editorStateManager) {
      const shouldBeDisabled = this.shouldEditorStateManagerBeDisabled();
      if (this.editorStateManager.isDisabled !== shouldBeDisabled) {
        this.editorStateManager.isDisabled = shouldBeDisabled;
      }
