...
import { functions } from 'onedata-gui-common/utils/atm-workflow/chart-dashboard-editor';
import { ChartNavigation } from 'onedata-gui-common/utils/time-series-dashboard';

/**
 * @type {string}
 */
const i18nPrefix = 'utils.atmWorkflow.chartDashboardEditor.createModel';

/**
 * Converts raw chart dashboard spec into a model used by dashboard editor.
 * @param {AtmTimeSeriesDashboardSpec | null} dashboardSpec
 * @param {unknown} elementsOwner
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.Model}
 */
 ...
 * @param {Utils.AtmWorkflow.ChartDashboardEditor.Model} dashboardModel
 */
 ...
 * @param {unknown} [elementOwner]
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.Chart}
 */
 ...
 * @param {unknown} [elementOwner]
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.Axis}
 */
 ...
 * @param {unknown} [elementOwner]
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.SeriesGroup}
 */
 ...
 * @param {unknown} [elementOwner]
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.Series}
 */
 ...
 * @param {unknown} [elementOwner]
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.FunctionModels.FunctionBase}
 */
 ...
 * @param {unknown} [elementOwner]
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @param {Object<string, Utils.AtmWorkflow.ChartDashboardEditor.Axis} [axesMap]
 * @param {Object<string, Utils.AtmWorkflow.ChartDashboardEditor.SeriesGroup} [groupsMap]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.Series}
 */
 ...
 * @param {unknown} [elementOwner]
 * @param {Array<ChartDashboardEditorDataSource>} [dataSources]
 * @returns {Utils.AtmWorkflow.ChartDashboardEditor.FunctionsModel.FunctionBase}
 */
