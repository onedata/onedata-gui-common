 ...
 * @param {Utils.AtmWorkflow.ChartDashboardEditor.ElementType} childElementType
 * @returns {string | null}
 */
...
export class ChangedElementsSet {
  constructor() {
    /**
     * @type {Set<Utils.AtmWorkflow.ChartDashboardEditor.ElementBase>}
     */
  ...
  /**
   * @public
   * @param {Utils.AtmWorkflow.ChartDashboardEditor.ElementBase} element
   * @returns {void}
   */
  addElement(element) {
