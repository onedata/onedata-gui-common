...
import { createNewFunction, ElementType } from 'onedata-gui-common/utils/atm-workflow/chart-dashboard-editor';
import { ChangedElementsSet } from './utils';

/**
 * @typedef {Object} AddFunctionActionContext
 * @property {string} newFunctionName
 * @property {Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase} targetFunction
 * @property {string} targetArgumentName
 * @property {number} [insertAtIndex]
 * @property {Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase | null} [functionToAttach]
...
export default Action.extend({
  ...
  /**
   * @returns {Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase | null}
   */
  createNewFunction() {
