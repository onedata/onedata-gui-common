 ...
 *
 * @module utils/one-histogram/configuration
 ...
 * @property {OneHistogramRawFunction} valueFormatter
 */
...
/**
 * @typedef {Object} OneHistogramExternalDataSourceRef
 * @property {'external'} sourceType
 * @property {OneHistogramExternalDataSourceRefParameters} sourceParameters
 */

/**
 * @typedef {Object} OneHistogramExternalDataSourceRefParameters
 ...
 * @property {(context: Partial<OneHistogramSeriesFunctionContext>, seriesTemplate: OneHistogramRawSeries) => Promise<OneHistogramSeries>} evaluateSeries
 */

/**
 * @typedef {OneHistogramSeriesContext} OneHistogramSeriesFunctionContext
 * @property {(context: Partial<OneHistogramSeriesFunctionContext>, seriesFunction: OneHistogramRawFunction) => Promise<OneHistogramSeriesPoint[]>} evaluateSeriesFunction
 * @property {(context: Partial<OneHistogramTransformFunctionContext>, transformFunction: OneHistogramRawFunction) => unknown} evaluateTransformFunction
 */
...
export default class OneHistogramConfiguration {
  ...
  /**
   * @param {OneHistogramSeries} series
   * @returns {void}
   */
  ...
  /**
   * @private
   * @param {OneHistogramSeries[]} seriesState
