/**
 * Shows workflow charts dashboard.
 *
...
export default Action.extend({
   ...
   * @override
   */
  i18nPrefix: 'components.workflowVisualiser.workflow.actions.viewWorkflowChartsDashboard',

  /**
   * @override
   */
  className: 'view-workflow-charts-dashboard-action-trigger',
