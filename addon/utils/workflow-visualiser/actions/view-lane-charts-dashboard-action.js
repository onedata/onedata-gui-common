...
export default Action.extend({
   ...
   * @override
   */
  i18nPrefix: 'components.workflowVisualiser.lane.actions.viewLaneChartsDashboard',

  /**
   * @override
   */
  className: 'view-lane-charts-dashboard-action-trigger',
