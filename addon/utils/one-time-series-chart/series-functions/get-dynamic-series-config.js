...
/**
 * @typedef {Object} OTSCGetDSCSeriesFunctionArguments
 * @property {string} [propertyName]
 */

/**
 * @param {OTSCSeriesFunctionContext} context
 * @param {OTSCGetDSCSeriesFunctionArguments} args
 * @returns {Promise<OTSCSeriesFunctionBasicResult<unknown>>}
 */
export default async function getDynamicSeriesConfig(context, args) {
  let data = null;
