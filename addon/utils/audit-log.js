 ...
 * It should not be the case for the logs generated by Onedata system itself,
 ...
 * Callback responsible for normalizing system logs content. When not provided,
 ...
 * @property {unknown} content Custom payload in unknown format (any JSON is valid).
 */
...
/**
 * @param {unknown} entry
 * @param {((content: unknown) => T|null)|undefined} [normalizeContent] Callback
 * responsible for normalizing system logs content. When not provided,
 * content will be "normalized as is" without changes.
...
export function normalizeEntry(entry, normalizeContent) {
  ...
  if (normalizedSource === EntrySource.System) {
    if (normalizeContent) {
