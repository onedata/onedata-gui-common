...
/**
 * @typedef {Object} WorkflowVisualiserChartDashboardEditorModalOptions
...
export default Component.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.modals.workflowVisualiser.chartDashboardEditorModal',
  ...
  /**
   * @virtual
   * @type {WorkflowVisualiserChartDashboardEditorModalOptions}
   */
   ...
   */
  dashboardModel: reads('dashboardOwner.chartDashboardEditorModelContainer.dashboardModel'),
