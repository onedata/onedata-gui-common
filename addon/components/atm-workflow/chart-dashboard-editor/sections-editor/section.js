...
export default OneDraggableObject.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.sectionsEditor.section',
  ...
  /**
   * @type {ComputedProperty<Utils.AtmWorkflow.ChartDashboardEditor.Section | null>}
   */
  ...
  /**
   * @type {ComputedProperty<Utils.AtmWorkflow.ChartDashboardEditor.Chart | null>}
   */
  ...
  actions: {
     ...
     * @param {Utils.AtmWorkflow.ChartDashboardEditor.Section} draggedElement
     * @returns {void}
     */
