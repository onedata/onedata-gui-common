...
import layout from 'onedata-gui-common/templates/components/atm-workflow/chart-dashboard-editor/chart-preview';
...
export default Component.extend({
  ...
  /**
   * @param {Utils.AtmWorkflow.ChartDashboardEditor.Chart} chart
   * @returns {void}
   */
