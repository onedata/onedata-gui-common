...
import layout from 'onedata-gui-common/templates/components/atm-workflow/chart-dashboard-editor/no-dashboard-info';
...
export default Component.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.noDashboardInfo',
