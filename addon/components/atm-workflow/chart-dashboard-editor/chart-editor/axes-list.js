...
import layout from 'onedata-gui-common/templates/components/atm-workflow/chart-dashboard-editor/chart-editor/axes-list';
...
export default Component.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.chartEditor.axesList',
...
const AxesListItemModel = ElementsListItemModel.extend({
   ...
   * @override
   */
  renderer: 'atm-workflow/chart-dashboard-editor/chart-editor/axes-list-item',
});
