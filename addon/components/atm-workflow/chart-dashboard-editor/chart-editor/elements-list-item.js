...
import layout from 'onedata-gui-common/templates/components/atm-workflow/chart-dashboard-editor/chart-editor/elements-list-item';
...
export default OneDraggableObject.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.chartEditor.elementsListItem',
