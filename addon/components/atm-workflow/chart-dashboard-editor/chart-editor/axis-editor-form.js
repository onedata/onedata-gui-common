...
export default Component.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.chartEditor.axisEditorForm',
...
const Form = FormFieldsRootGroup.extend({
  /**
   * @virtual
   * @type {Components.AtmWorkflow.ChartDashboardEditor.ChartEditor.AxisEditorForm}
   */
  component: undefined,
