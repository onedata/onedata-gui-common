...
import layout from 'onedata-gui-common/templates/components/atm-workflow/chart-dashboard-editor/chart-editor/elements-list';

/**
 * @typedef {Object} ElementsListDropZone
 * @property {SafeString} style
 * @property {Utils.AtmWorkflow.ChartDashboardEditor.ChartElement} referenceElement
...
export const ElementsListItemModel = EmberObject.extend({
  ...
  /**
   * @returns {Array<Utils.AtmWorkflow.ChartDashboardEditor.ChartElement>}
   */
  getAllNestedItems() {
...
export default PerfectScrollbarElement.extend({
  ...
  /**
   * @returns {Map<string, Utils.AtmWorkflow.ChartDashboardEditor.ChartElement>}
   */
  getAllItemsMap() {
    const itemsArray = [
  ...
  actions: {
     ...
     * @param {Utils.AtmWorkflow.ChartDashboardEditor.ChartElement}
     * @returns {void}
     */
