...
export default Component.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.chartEditor.seriesGroupsList',
...
const SeriesGroupListItemModel = ElementsListItemModel.extend({
   ...
   * @override
   */
  renderer: 'atm-workflow/chart-dashboard-editor/chart-editor/series-groups-list-item',
