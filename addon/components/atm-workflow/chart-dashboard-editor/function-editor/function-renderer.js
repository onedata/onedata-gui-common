 ...
 * @property {Array<Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase>} attachedFunctions
...
export default OneDraggableObject.extend(I18n, {
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.functionEditor.functionRenderer',
  ...
  settingsComponentName: computed(
    ...
    function settingsComponentName() {
      ...
      return `atm-workflow/chart-dashboard-editor/function-editor/${dasherize(this.chartFunction.name)}-settings`;
    }
  ),
  ...
  /**
   * @type {ComputedProperties<Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase | null>}
   */
  ...
  actions: {
     ...
     * @param {Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase | null} referenceFunction
     * @param {Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase} draggedFunction
     */
