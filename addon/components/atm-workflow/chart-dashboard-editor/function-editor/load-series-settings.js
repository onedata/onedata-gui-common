...
import layout from 'onedata-gui-common/templates/components/atm-workflow/chart-dashboard-editor/function-editor/load-series-settings';
...
export const TimeSeriesSelector = FormFieldsGroup.extend({
   ...
   * @override
   */
  i18nPrefix: 'components.atmWorkflow.chartDashboardEditor.functionEditor.loadSeriesSettings.fields.timeSeriesSelector',
