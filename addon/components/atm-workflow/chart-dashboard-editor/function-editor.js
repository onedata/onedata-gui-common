...
import { ElementType, EdgeScroller } from 'onedata-gui-common/utils/atm-workflow/chart-dashboard-editor';
import layout from 'onedata-gui-common/templates/components/atm-workflow/chart-dashboard-editor/function-editor';
...
export default Component.extend({
  ...
  /**
   * @virtual
   * @type {Array<Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase>}
   */
  ...
  actions: {
    ...
    /**
     * @param {Utils.AtmWorkflow.ChartDashboardEditor.FunctionBase} chartFunction
